...
ggplot(subway2,aes(x = times)) +
  ...
  scale_x_continuous(breaks = seq(6,24,6)) +
  # scale_fill_gradient(low = "#E7AB79", high = "#B25068") + #서울역
  # scale_fill_gradient(low = "#B2C8DF", high = "#495C83") + # 여의도
  scale_fill_gradient(low = "#98B4AA", high = "#596E79") + # 화곡
  # scale_fill_gradient(low = "#889EAF", high = "#506D84") +
...
ggsave(paste0("~/github/ggplot2/2022/20220714/result3_20220714.png"),
