...
ggsave("~/github/ggplot2/2022/20220812/save_ggplot_blog_2x1_01.png", 
...
ggsave("~/github/ggplot2/2022/20220812/save_ggplot_blog_2x1_02.png", 
       width = 8, height = 4, dpi = 320, units = "in")

ggplot(tb, aes(x,y, fill = z)) +
  geom_chicklet(width = 0.7, colour = NA, radius = grid::unit(5, "pt")) + 
  scale_fill_manual(values = c("#424242", "#CAFA93")) + 
  theme_void() +
...
ggplot(tb, aes(x,y, fill = z)) +
  ...
  scale_fill_manual(values = c("#424242", "#CAFA93")) + #94D4FB #8AB2F9 #7D84F7
...
ggsave("~/github/ggplot2/2022/20220812/save_ggplot_2x1_02.png", 
       width = 8, height = 4, dpi = 320, units = "in")
