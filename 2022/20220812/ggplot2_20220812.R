...
ggsave("~/github/ggplot2/2022/20220812/save_ggplot_2x1_01.png", 
...
ggplot(tb, aes(x,y, fill = z)) +
  geom_chicklet(width = 0.7, colour = NA, radius = grid::unit(5, "pt")) + # "#424242"
  scale_fill_manual(values = c("#424242", "#FA9C93")) + #94D4FB #8AB2F9 #7D84F7
  scale_x_continuous(expand = expansion(c(0,0))) +
  theme_void() +
  labs(caption = "twitter @sourcebox7") +
  theme(legend.position = "none",
...
ggsave("~/github/ggplot2/2022/20220812/save_ggplot_2x1_03.png", 
       width = 8, height = 4, dpi = 320, units = "in")
