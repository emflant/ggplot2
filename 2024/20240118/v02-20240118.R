...
ggplot(b) +
  ...
  annotate("text", x = -1, y = 2.2, label = "st_buffer(dist = 1)", 
...
ggsave(filename = "./2024/20240118/v02-01.png", 
...
ggsave(filename = "./2024/20240118/v02-02.png", 
       device = grDevices::png,
       width = 6, height = 4.5, dpi = 180, units = "in")
...
ggsave(filename = "./2024/20240118/v02-03.png", 
       device = grDevices::png,
       width = 6, height = 4.5, dpi = 180, units = "in")
...
ggsave(filename = "./2024/20240118/v02-04.png", 
       device = grDevices::png,
       width = 6, height = 4.5, dpi = 180, units = "in")
...
ggsave(filename = "./2024/20240118/v02-05.png", 
       device = grDevices::png,
       width = 6, height = 4.5, dpi = 180, units = "in")
