...
ggsave("./2023/20230331/v1_01.png",
...
ggsave("./2023/20230331/v1_02.png",
       width = 6, height = 4, dpi = 240, units = "in")
...
ggplot(tb2, aes(date, value)) +
  geom_line(size = 1) +
  geom_text(data = tb3, aes(label = formatC(value, format="f", big.mark=",", digits = 0)), 
            vjust = tb3$height,
...
ggsave("./2023/20230331/v1_03.png",
       width = 6, height = 4, dpi = 240, units = "in")
...
paste0(seq(20000, 80000, 20000) / 1000, "K")

ggplot(tb2, aes(date, value)) +
  geom_line(size = 1, colour = v_line_color) +
  geom_point(size = 1.5,colour = v_line_color) +
  geom_text(data = tb3, aes(label = formatC(value, format="f", big.mark=",", digits = 0)),
            vjust = tb3$height,
            colour = v_line_color,
            family = v_font_bm, size = 4.5) +
  ...
  theme(plot.background = element_rect(fill = v_dark_bgcolor, color = v_dark_bgcolor),
        plot.margin = margin(0.3,0.3,0.3,0.2,"in"),
...
ggsave("./2023/20230331/v1_11.png",
       width = 6, height = 4, dpi = 240, units = "in")
